$(document).ready(function() {
    ...
    var firebaseConfig = {
        apiKey: "AIzaSyBD9NrLEa5TNImvmVjnwS3uBKfsP65ZWmE",
        authDomain: "taskexpensep.firebaseapp.com",
        databaseURL: "https://taskexpensep.firebaseio.com",
        projectId: "taskexpensep",
        storageBucket: "taskexpensep.appspot.com",
        messagingSenderId: "126050373963",
        appId: "1:126050373963:web:1b19fd4546db49e9f118ce"
    };
    // Initialize Firebase
        ...
        $('#credittable').on('click', '.display', function () {
            ...
            $('#expenseModal').html(`
  					<label class="font-weight-bold">Expense Name:</label><br>
						...
						<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        				<button type="button" data-id="${taskId}" class="btn btn-primary update" id="save_change">Save changes</button>
    ...
    $('#save_change').on('click', function (){
        $('#exampleModalCenter').modelGroups('hide');
    })
